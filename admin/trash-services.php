<?php
  ...
  $selectcount = "SELECT COUNT(*) as total FROM services WHERE status = 2";
...
<div class="card">
  <div class="card-header bg-primary">
    <h3 class="card-title">Trash Service <?php if($assoc['total'] == 0 ){
             ...
             <tr>
                ...
                <?php 
                  if (isset($services['title'])) { ?>
                    ...
                    <a class="btn btn-info btn-sm" href="restore-services.php?id=<?= $services['id'] ?>">
                        <i class="fa fa-undo">
                        </i>
                        Restore
                    </a>
                    <a class="btn btn-danger btn-sm" href="delete-permanent-services.php?id=<?= $services['id'] ?>">
