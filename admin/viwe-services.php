<?php
  ...
  $selectcount = "SELECT COUNT(*) as total FROM services WHERE status = 1";
...
<div class="card">
  <div class="card-header bg-primary">
    <h3 class="card-title">View Service <?php if($assoc['total'] == 0 ){
             ...
             <tr>
                ...
                <?php 
                  if (isset($services['title'])) { ?>
                    ...
                    <a class="btn btn-info btn-sm" href="edit-services.php?id=<?= $services['id'] ?>">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="delete-services.php?id=<?= $services['id'] ?>">
                        <i class="fa fa-ban">
                        </i>
                        Delete
                    </a>
