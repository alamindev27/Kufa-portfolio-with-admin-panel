<?php
  ...
  $selectma = "SELECT * FROM message WHERE status = 2 ORDER BY id DESC";
  $maq = mysqli_query($conn, $selectma);

  $totalcount = "SELECT COUNT(*) as total_message FROM message WHERE status = 2";
  ...
  <div class="col-md-9">
    ...
    <div class="card card-primary card-outline">
      ...
      <div class="card-body p-0">
        ...
        <form action="delete-message-permanent.php" method="post">
