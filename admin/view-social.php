<?php
  ...
  $selectcount = "SELECT COUNT(*) as total FROM social WHERE status = 1";
             ...
             <tr>
                ...
                <?php 
                  if (isset($social['icon'])) { ?>
                    ...
                    <a class="btn btn-info btn-sm" href="edit-social.php?id=<?= $social['id'] ?>">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="delete-social.php?id=<?= $social['id'] ?>">
                        <i class="fa fa-ban">
                        </i>
                        Delete
                    </a>
