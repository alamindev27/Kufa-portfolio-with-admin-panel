...
<div class="card card-primary" style="width:500px;margin: 0 auto;">
  <div class="card-header">
    <h3 class="card-title text-uppercase">edit counterup</h3>
  </div>
  <form action="update-counterup.php" method="post">
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="number" min="1" name="counter" placeholder="Enter counter" class="form-control" value="<?= $assoc['counter'] ?>">
      </div>
      <div class="form-group">
        <label">Icon</label>
    ...
    <div class="card-footer text-center">
      <button type="submit" class="btn btn-primary">Save Counterup</button>
    </div>
  </form>
</div>
