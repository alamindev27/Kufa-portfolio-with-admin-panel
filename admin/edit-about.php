...
<div class="card card-primary" style="width:500px;margin: 0 auto;">
  <div class="card-header">
    <h3 class="card-title text-uppercase">edit about</h3>
  </div>
  <form action="update-about.php" method="post">
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="heading" placeholder="enter heading" required  value="<?= $assoc['heading'] ?>">
      </div>
      <div class="form-group">
        <label">Description</label>
        <textarea class="form-control" name="description" rows="3" required placeholder="Enter Description"><?= ltrim($assoc['description']) ?>
        </textarea>
      </div>
    </div>
      <?php
