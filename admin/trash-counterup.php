<?php
  ...
  $selectcount = "SELECT COUNT(*) as total FROM counterup WHERE status = 2";
...
<div class="card">
  <div class="card-header bg-primary">
    <h3 class="card-title">Trash Counterup <?php if($assoc['total'] == 0 ){
             ...
             <tr>
                ...
                <?php 
                  if (isset($counter['title'])) { ?>
                    ...
                    <a class="btn btn-info btn-sm" href="restore-counterup.php?id=<?= $counter['id'] ?>">
                        <i class="fa fa-undo">
                        </i>
                        Restore
                    </a>
                    <a class="btn btn-danger btn-sm" href="delete-permanent-counterup.php?id=<?= $counter['id'] ?>">
                        <i class="fa fa-trash">
                        </i>
                        Delete Permanent
                    </a>
