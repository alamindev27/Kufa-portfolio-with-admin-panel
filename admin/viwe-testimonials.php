<?php
  ...
  $selectcount = "SELECT COUNT(*) as total FROM Testimonials WHERE status = 1";
             ...
             <tr>
                ...
                <?php 
                  if (isset($testimonials['title'])) { ?>
                    ...
                    <a class="btn btn-info btn-sm" href="edit-testimonials.php?id=<?= $testimonials['id'] ?>">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm" href="delete-testimonials.php?id=<?= $testimonials['id'] ?>">
                        <i class="fa fa-ban">
                        </i>
                        Delete
                    </a>
